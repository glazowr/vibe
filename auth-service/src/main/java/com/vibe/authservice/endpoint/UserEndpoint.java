package com.vibe.authservice.endpoint;

import com.vibe.authservice.exception.*;
import com.vibe.authservice.model.VibeUserDetails;
import com.vibe.authservice.model.Profile;
import com.vibe.authservice.model.User;
import com.vibe.authservice.payload.*;
import com.vibe.authservice.service.JwtTokenProvider;
import com.vibe.authservice.service.UserService;
...
public class UserEndpoint {
    ...
    public ResponseEntity <?> updateProfilePicture(
            ...
            @AuthenticationPrincipal VibeUserDetails userDetails) {
    ...
    public UserSummary getCurrentUser(@AuthenticationPrincipal VibeUserDetails userDetails) {
        return UserSummary
                .builder()
